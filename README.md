...
The GitHub repository can be found [here](https://github.com/meyayl/ocrmypdf-batch).
The Docker Hub repository can be found [here](https://hub.docker.com/r/meyay/ocrmypdf-batch).
